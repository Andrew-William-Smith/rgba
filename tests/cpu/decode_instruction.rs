...
fn single_data_transfer() {
    ...
    decode_succeeds!(
        ...
        0xE5943000 => "ldr r3,[r4]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: Immediate(0) },
        0xE5843000 => "str r3,[r4]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: false, base: r(4) }, target: r(3), offset: Immediate(0) },
        0xE5D43000 => "ldrb r3,[r4]" => SingleDataTransfer { condition: Always, transfer_byte: true, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: Immediate(0) },
        0xE5C43000 => "strb r3,[r4]" => SingleDataTransfer { condition: Always, transfer_byte: true, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: false, base: r(4) }, target: r(3), offset: Immediate(0) },
        // Pre- and post-indexed immediate offsets.
        0xE5943F00 => "ldr r3,[r4,#+0xF00]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE5143F00 => "ldr r3,[r4,#-0xF00]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: false, write_back: false, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE5B43F00 => "ldr r3,[r4,#+0xF00]!" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: true, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE5343F00 => "ldr r3,[r4,#-0xF00]!" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: false, write_back: true, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE4943F00 => "ldr r3,[r4],#+0xF00" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: false, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE4143F00 => "ldr r3,[r4],#-0xF00" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: false, add_offset: false, write_back: false, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE4B43F00 => "ldrt r3,[r4],#+0xF00" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: false, add_offset: true, write_back: true, load: true, base: r(4) }, target: r(3), offset: Immediate(0xF00) },
        0xE4EBA437 => "strbt r10,[r11],#+0x437" => SingleDataTransfer { condition: Always, transfer_byte: true, opt: DataTransferOptions { pre_index: false, add_offset: true, write_back: true, load: false, base: r(11) }, target: r(10), offset: Immediate(0x437) },
        // Pre- and post-indexed shift offsets.  Only immediate shifts are available.
        0xE7943005 => "ldr r3,[r4,+r5]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: ShiftImmediate(LogicalShiftLeft, 0, r(5)) },
        0xE7143005 => "ldr r3,[r4,-r5]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: false, write_back: false, load: true, base: r(4) }, target: r(3), offset: ShiftImmediate(LogicalShiftLeft, 0, r(5)) },
        0xE79433C5 => "ldr r3,[r4,+r5,asr #7]" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: ShiftImmediate(ArithmeticShiftRight, 7, r(5)) },
        0xE7343065 => "ldr r3,[r4,-r5,rrx]!" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: true, add_offset: false, write_back: true, load: true, base: r(4) }, target: r(3), offset: ShiftImmediate(RotateRight, 0, r(5)) },
        0xE6143005 => "ldr r3,[r4],-r5" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: false, add_offset: false, write_back: false, load: true, base: r(4) }, target: r(3), offset: ShiftImmediate(LogicalShiftLeft, 0, r(5)) },
        0xE6943305 => "ldr r3,[r4],+r5,lsl #6" => SingleDataTransfer { condition: Always, transfer_byte: false, opt: DataTransferOptions { pre_index: false, add_offset: true, write_back: false, load: true, base: r(4) }, target: r(3), offset: ShiftImmediate(LogicalShiftLeft, 6, r(5)) },
        // And a kitchen sink instruction.
        0xC66BAFCC => "strgtbt r10,[r11],-r12,asr #31" => SingleDataTransfer { condition: Greater, transfer_byte: true, opt: DataTransferOptions { pre_index: false, add_offset: false, write_back: true, load: false, base: r(11) }, target: r(10), offset: ShiftImmediate(ArithmeticShiftRight, 31, r(12)) },
    );
}
