...
fn single_data_transfer() {
    ...
    decode_succeeds!(
        ...
        0xE5943000 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: Immediate(0) } => "ldr r3,[r4]",
        0xE5843000 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: false, write_back: false, load: false, base: 4, target: 3, offset: Immediate(0) } => "str r3,[r4]",
        0xE5D43000 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: true, write_back: false, load: true, base: 4, target: 3, offset: Immediate(0) } => "ldrb r3,[r4]",
        0xE5C43000 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: true, write_back: false, load: false, base: 4, target: 3, offset: Immediate(0) } => "strb r3,[r4]",
        // Pre- and post-indexed immediate offsets.
        0xE5943F00 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldr r3,[r4,#+0xF00]",
        0xE5143F00 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: false, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldr r3,[r4,#-0xF00]",
        0xE5B43F00 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: false, write_back: true, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldr r3,[r4,#+0xF00]!",
        0xE5343F00 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: false, transfer_byte: false, write_back: true, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldr r3,[r4,#-0xF00]!",
        0xE4943F00 => SingleDataTransfer { condition: Always, pre_index: false, add_offset: true, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldr r3,[r4],#+0xF00",
        0xE4143F00 => SingleDataTransfer { condition: Always, pre_index: false, add_offset: false, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldr r3,[r4],#-0xF00",
        0xE4B43F00 => SingleDataTransfer { condition: Always, pre_index: false, add_offset: true, transfer_byte: false, write_back: true, load: true, base: 4, target: 3, offset: Immediate(0xF00) } => "ldrt r3,[r4],#+0xF00",
        0xE4EBA437 => SingleDataTransfer { condition: Always, pre_index: false, add_offset: true, transfer_byte: true, write_back: true, load: false, base: 11, target: 10, offset: Immediate(0x437) } => "strbt r10,[r11],#+0x437",
        // Pre- and post-indexed shift offsets.  Only immediate shifts are available.
        0xE7943005 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: ShiftImmediate(LogicalShiftLeft, 0, 5) } => "ldr r3,[r4,+r5]",
        0xE7143005 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: false, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: ShiftImmediate(LogicalShiftLeft, 0, 5) } => "ldr r3,[r4,-r5]",
        0xE79433C5 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: true, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: ShiftImmediate(ArithmeticShiftRight, 7, 5) } => "ldr r3,[r4,+r5,asr #7]",
        0xE7343065 => SingleDataTransfer { condition: Always, pre_index: true, add_offset: false, transfer_byte: false, write_back: true, load: true, base: 4, target: 3, offset: ShiftImmediate(RotateRight, 0, 5) } => "ldr r3,[r4,-r5,rrx]!",
        0xE6143005 => SingleDataTransfer { condition: Always, pre_index: false, add_offset: false, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: ShiftImmediate(LogicalShiftLeft, 0, 5) } => "ldr r3,[r4],-r5",
        0xE6943305 => SingleDataTransfer { condition: Always, pre_index: false, add_offset: true, transfer_byte: false, write_back: false, load: true, base: 4, target: 3, offset: ShiftImmediate(LogicalShiftLeft, 6, 5) } => "ldr r3,[r4],+r5,lsl #6",
        // And a kitchen sink instruction.
        0xC66BAFCC => SingleDataTransfer { condition: Greater, pre_index: false, add_offset: false, transfer_byte: true, write_back: true, load: false, base: 11, target: 10, offset: ShiftImmediate(ArithmeticShiftRight, 31, 12) } => "strgtbt r10,[r11],-r12,asr #31",
    );
}
